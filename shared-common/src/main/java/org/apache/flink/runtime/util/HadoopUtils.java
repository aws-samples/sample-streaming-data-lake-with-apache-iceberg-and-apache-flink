...
/**
 * This class is a copy of org.apache.flink.runtime.util.HadoopUtils with the getHadoopConfiguration() 
 * method replaced to return an org.apache.hadoop.conf.Configuration instead of 
 * org.apache.hadoop.hdfs.HdfsConfiguration.
 *
 * This class is then shaded, along with org.apache.hadoop.conf.*, to avoid conflicts with the same 
 * classes provided by org.apache.flink:flink-s3-fs-hadoop, which is normally installed as plugin 
 * in Flink when S3.
 *
 * Other methods are copied from the original class.
 * 
 * @see <a href="https://github.com/aws-samples/amazon-managed-service-for-apache-flink-examples">AWS Managed Flink Examples</a>
 */
